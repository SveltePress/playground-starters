...
`versions build` is Degraded: Pagefind-backed production build is not full in WebContainers. Inspect `sveltepress.versions.json` and the frozen snapshot under `src/routes/v/1.0/`.
